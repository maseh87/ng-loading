...
.directive('loader', function(loading) {
  ...
  var checkClass = loading.config.class.slice(0, 2);
  ...
  var templates = {
    ...
    'fa': '<div class="' + loading.config.overlay.display + ' fade-out">' + '<i class="' + loading.config.class +  ' fa-spin fa-5x wrapper"></i>' + '</div>'
  };
